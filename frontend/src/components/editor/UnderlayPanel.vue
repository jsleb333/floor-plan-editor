...
const emit = defineEmits<{
  /** The user asked to (re)calibrate — the page arms the Calibrate tool (spec U2). */
  recalibrate: []
}>()
...
<template>
  <section aria-label="Underlay" class="flex flex-col gap-2 text-xs">
    ...
    <template v-else>
      ...
      <p class="text-ink-muted tabular-nums" aria-label="Underlay origin">
